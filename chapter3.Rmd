...
names(alc)
```  
The data is a combination of questionnaire and grade data of 382 students , collected from two secondary schools in Portugal (see Cortez & Silva, 2008, http://www3.dsi.uminho.pt/pcortez/student.pdf). Dataset includes some basic background information on students (gender, age, whether their address is in urban (U) or rural (R) environment), their family relations (e.g. family size and information about parents) and school history (e.g. extra support from school/home, paid extra classes) and grades (G1-G3, averages of maths and portugues grades for 1st, 2nd and 3rd period). Students have also been asked about time and motivation they spend on studies, and some questions about their free time use.  

Average of alcohol consumption (alc_use) has been calculated from average of scores (1=very low, 5=very high) with which student described their alcohol use during week or in the week ends. If the average score is above 2, student is considered to have a high alcohol use.

### 3.3 Select 4 interesting variables potentially related to high or low alcohol use --> formulate hypotheses 
